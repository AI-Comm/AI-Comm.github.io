...
layout: page
title: >
  A paper titled "DASK-Net: A Lightweight Dual Attention Selective Kernel Network for Efficient Dense Prediction in Remote Sensing Imagery" got accepted to IEEE Transactions on Geoscience and Remote Sensing (IF 8.6, JCR Q1 Rank 6.7%)!
image: 
