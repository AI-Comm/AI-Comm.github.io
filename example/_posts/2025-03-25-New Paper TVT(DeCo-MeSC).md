...
layout: page
title: >
  A paper titled "DeCo-MeSC: Deep Compression-Based Memory-Constrained Split Computing Framework for Cooperative Inference of Neural Network" got accepted to IEEE Transactions on Vehicular Technology (IF 6.1, JCR Q1 Rank 12.2%)!
image: 
